#SCF_SPLR: SCF model with SPLR optimization
...
for i in range(1):
    ...
    for j in range(1):
        path_excel = 'E:\\experiment_result\\' + dataset_list[dataset] + '_SCF0SPLR_' + str(int(time.time())) + str(int(random.uniform(100,900))) + '.xls'
        save_parameter()
        print_parameter()
        train_SPLR(eta)